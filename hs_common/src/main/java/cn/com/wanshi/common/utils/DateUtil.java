package cn.com.wanshi.common.utils;
...
public class DateUtil {
    ...
    public static String getDateString(Date date, String formatString) {
        ...
        SimpleDateFormat fmtObj = new SimpleDateFormat(formatString);
        try {
            dateStr = fmtObj.format(date);
        }catch (Exception e){
    ...
    public static String getRelativeDateString(
            ...
            int relate,
            String formatString) {
        return getDateString(getRelativeDate(type, relate));
    }
    ...
    */
    ...
    public static String getAfterNDayStr(int iParam) {// iParam天后日期
        ...
        String sSS = now.get(Calendar.SECOND) > 9 ? ""
                + now.get(Calendar.SECOND) : "0" + now.get(Calendar.SECOND);
