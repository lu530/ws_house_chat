package cn.com.wanshi.chat.exception;

import cn.com.wanshi.common.BaseErrorCode;
import cn.com.wanshi.common.ResponseVO;
import cn.com.wanshi.common.exception.ApplicationException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseVO unknowException(Exception e){
        ...
        resultBean.setStatus(BaseErrorCode.SYSTEM_ERROR.getCode());
    ...
    public Object handleMethodArgumentNotValidException(ConstraintViolationException ex) {
        ...
        ResponseVO resultBean =new ResponseVO();
        resultBean.setStatus(BaseErrorCode.PARAMETER_ERROR.getCode());
